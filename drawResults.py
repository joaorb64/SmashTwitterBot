...
def drawResults(event, standings, page=1):
  ...
  d.text((20, 680), "Gerado por @smash_bot_br usando dados do smash.gg", font=fnt, fill=(255, 255, 255), align="center")

  if is_top16:
    d.text((1280-40, 680), str(page)+"/2", font=fnt, fill=(255, 255, 255), align="center")
